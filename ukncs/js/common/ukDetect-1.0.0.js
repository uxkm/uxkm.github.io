...
//ready
	var device_check, desktopOs_check, deviceOs_check, browser_check, deviceName_check, ie_class, ie_version;
...
//browser check
	function browser_add(){
		...
		if(agent.indexOf('edge/') > -1){
			browser_check = 'ie edge'+new_b;
		}
		//chrome
		else if(agent.indexOf("chrome") !== -1){
			browser_check = 'chrome'+ie_no+new_b;
		}
		//opera
		else if(agent.indexOf("opera") !== -1){
			browser_check = 'opera'+ie_no+new_b;
		}
		//firefox
		else if(agent.indexOf("firefox") !== -1){
			browser_check = 'firefox'+ie_no+new_b;
		}
		//safari
		else if(agent.indexOf("safari") !== -1){
			browser_check = 'safari'+ie_no+new_b;
		}
		//skipstone
		else if(agent.indexOf("skipstone") !== -1){
			browser_check = 'skipstone'+ie_no+new_b;
		}
		//ie
		...
		//netscape
			...
			browser_check = 'netscape'+ie_no;
		}
		//etc_browser
		else{
			browser_check = 'etc_browser'+ie_no;
		}
